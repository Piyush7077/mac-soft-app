...
T=Label(LHS, text=my_system.node,bg="#f4f5f5",font=("Acumin Variable Concept",15,'bold'),justify="center")
T.place(x=20,y=200)

L=Label(LHS, text=f"Version:{my_system.version}",bg="#f4f5f5",font=("Acumin Variable Concept",8),justify="center")
L.place(x=20,y=225)

K=Label(LHS, text=f"System:{my_system.system}",bg="#f4f5f5",font=("Acumin Variable Concept",15),justify="center")
K.place(x=20,y=250)

P=Label(LHS, text=f"Machine:{my_system.machine}",bg="#f4f5f5",font=("Acumin Variable Concept",15),justify="center")
P.place(x=20,y=285)

O=Label(LHS, text=f"Total RAM installed:{round(psutil.virtual_memory().total/1000000000,2)} GB",bg="#f4f5f5",font=("Acumin Variable Concept",15),justify="center")
O.place(x=20,y=310)

J=Label(LHS, text=f"Processor:{my_system.processor}",bg="#f4f5f5",font=("Acumin Variable Concept",7),justify="center")
J.place(x=20,y=340)
...
##############################################
button_mode=True
l1 = Label(LHS, text="Label 1")
l2 = Label(LHS, text="Label 2")
l3 = Label(LHS, text="Label 3")
l4 = Label(LHS, text="Label 4")
l5 = Label(LHS, text="Label 5")
l6 = Label(LHS, text="Label 6")

# Make them global if the function needs to modify them
def mode():
    global button_mode, l1, l2, l3, l4, l5, l6  # Include these in global scope if needed
